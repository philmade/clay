...
#
# This is a Starlark script — a Python dialect that runs embedded in Clay.
# It runs instantly, no compilation needed. Scripts in /app/data/extensions/ persist
# across restarts.
#
# Usage: extension_run(name="hello", args={"name": "Clay"})
#
# Available builtins:
...
def run(args):
    ...
    return "Hello, " + name + "! I'm a Starlark extension running inside Clay."
